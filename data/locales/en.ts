...
export const en: Dictionary = {
  ...
  instagram: {
    ...
    follow: "Follow us",
    captions: {
      "ig-1": "Minimally invasive veneers, a naturally balanced smile",
      "ig-2": "A finished smile makeover with e.max crowns",
      "ig-3": "E.max work, checked in the mirror",
      "ig-4": "Crown restoration complete: from damaged to durable",
      "ig-5": "E.max crowns in a natural white",
      "ig-6": "Smile makeover, before and after",
      "ig-7": "Full-mouth rehabilitation",
      "ig-8": "E.max crowns and bridges",
      "ig-9": "Layered zirconia, before and after",
      "ig-10": "Close-up of a finished restoration",
    },
  },
