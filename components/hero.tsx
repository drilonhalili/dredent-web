...
import { business, trustLine } from "@/data/site-config";
    ...
    <section id="top" className="relative overflow-hidden pb-16 pt-28 sm:pb-24 sm:pt-36">
      ...
      <Container className="relative grid items-center gap-12 lg:grid-cols-[1.15fr_1fr] lg:gap-8">
        <motion.div variants={container} initial="hidden" animate="show">
          ...
          >
            General &amp; Cosmetic Dentistry — Tetovo
          </motion.p>
          ...
          >
            See your smile <span className="italic text-shade">before it exists.</span>
          </motion.h1>

          <motion.p variants={item} className="mt-6 max-w-lg text-balance text-lg leading-relaxed text-ink-soft">
            A digital scan, a precise porcelain match, and a preview you sign off on before we
            touch a single tooth.
          </motion.p>

          <motion.div variants={item} className="mt-8 flex flex-wrap items-center gap-4">
            <ButtonLink href={business.bookingHref}>Book a consultation</ButtonLink>
          ...
          <motion.div variants={item} className="mt-10 flex flex-wrap items-center gap-3">
            ...
            <p className="font-mono text-[0.7rem] text-ink-soft">{trustLine}</p>
          </motion.div>
        </motion.div>
